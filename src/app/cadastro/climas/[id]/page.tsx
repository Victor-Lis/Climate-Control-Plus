...
export default function Clima({ params }: { params: ParamsType }) {
  ...
  useEffect(() => {
    ...
    async function handleGetClima(){
      let data = await getClima({id: params.id})
      if(data){
        setValue("temperatura", String(data.temperatura_do_comodo))
        setValue("humidade", String(data.humidade_do_comodo))
      }
    }
