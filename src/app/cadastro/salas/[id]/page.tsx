...
import { getComodo } from './utils/getComodo';

interface ParamsType {
  id: string;
}

export default function Comodo({ params }: { params: ParamsType }) {
  ...
  useEffect(() => {
    ...
    async function handleGetComodo(){
      let data = await getComodo({id: params.id})
      if(data){
